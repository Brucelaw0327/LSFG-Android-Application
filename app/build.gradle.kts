...
android {
    // The privileged-capture mechanism intentionally reflects into framework
    // internals; SurfaceControl.mNativeObject access is runCatching-guarded
    // and only this check trips on it, so exempt it project-wide.
    lint {
