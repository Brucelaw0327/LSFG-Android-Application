...
object NativeBridge {
    ...
    /**
     * True when the overlay output keeps stalling even after repeated swapchain
     * recreates (HDR color-mode switch can drop the overlay from composition).
     * The service watchdog polls this to end the session gracefully.
     */
    external fun isOutputStalled(): Boolean
